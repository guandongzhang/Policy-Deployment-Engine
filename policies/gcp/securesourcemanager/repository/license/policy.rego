package terraform.gcp.security.securesourcemanager.repository.license
...
conditions := [
    [
    {"situation_description" : "The project must include a valid open-source license from the approved list to ensure compliance",
